...
<head>
	...
	<meta charset="utf-8">
<title>Rising 5th Web Design|Web Design Cheshire</title>
<meta charset="utf-8">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="splash-text">
								...
								<h1 class="splash-headline">We Connect your business with the Web</h1>
								<div class="splash-description">
									<p>linking the physical to the technical</p>
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="splash-text">
								...
								<div class="splash-description">
									<p>Every client working with us are always satisfied, we can prove it!</p>
								</div>
							</div>
